    ...
    public class AWSManager : MonoBehaviour
    {
        ...
        private async void Start()
        {
            ...
            */
            ...
            /*var result = GetWorldList("127.09923230777225", "37.41370554789107", "10");
            print($"result : {result}");*/
        }
        ...
        public async Task UploadDirectory(string existingBucketName, string path, Action onComplete = null, Action<Exception> onError = null)
        {
            try
            {
        ...
        public async Task<JArray> GetUserWorldList(string userId)
        {
        ...
        public async Task<JArray> PostMap(string owner)
        {
            string pathAPI = "/map";
            JObject result = null;
            try
        ...
        public async Task PutMapInfo(string name, string id, bool is_public, float longitude, float latitude)
        {
            string pathAPI = "/map";
            JObject result = null;
            try
            {
                ...
                request.Headers.Add("is_public", is_public.ToString());
                request.Headers.Add("longitude", longitude.ToString());
                request.Headers.Add("latitude", latitude.ToString());
                using (WebResponse response = await request.GetResponseAsync())
                using (Stream dataStream = response.GetResponseStream())
                using (StreamReader reader = new StreamReader(dataStream))
                {
        ...
        public async Task<JArray> GetMapAreaTarget(string mapid)
        {
            string pathAPI = "/map/areatarget";
            JObject result = null;
            try
            {
                WebRequest request = WebRequest.Create(BaseAPI + pathAPI);
                request.Method = "GET";
                request.ContentType = "application/json";
                request.Headers.Add("mapid", mapid);
        ...
        public async Task<JArray> PostWorld(string owner, string map, string name, bool activate, string description)
        {
            ...
            try
            {
                ...
                request.ContentType = "application/json";
                request.Headers.Add("owner", owner);
                request.Headers.Add("map", map);
                request.Headers.Add("name", name);
                request.Headers.Add("activate", activate.ToString());
                request.Headers.Add("description", description);
        ...
        public async Task PostMapAreaTarget(string mapid, string name)
        {
            string pathAPI = "/map/areatarget";
            JObject result = null;
            try
